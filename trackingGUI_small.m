function varargout = trackingGUI_small(varargin)
% TRACKINGGUI_SMALL MATLAB code for trackingGUI_small.fig
%      TRACKINGGUI_SMALL, by itself, creates a new TRACKINGGUI_SMALL or raises the existing
%      singleton*.
%
%      H = TRACKINGGUI_SMALL returns the handle to a new TRACKINGGUI_SMALL or the handle to
%      the existing singleton*.
%
%      TRACKINGGUI_SMALL('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in TRACKINGGUI_SMALL.M with the given input arguments.
%
%      TRACKINGGUI_SMALL('Property','Value',...) creates a new TRACKINGGUI_SMALL or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before trackingGUI_small_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to trackingGUI_small_OpeningFcn via varargin.
%
...
% Edit the above textLD1 to modify the response to help trackingGUI_small

% Last Modified by GUIDE v2.5 03-Feb-2020 14:33:46

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @trackingGUI_small_OpeningFcn, ...
                   'gui_OutputFcn',  @trackingGUI_small_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before trackingGUI_small is made visible.
function trackingGUI_small_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to trackingGUI_small (see VARARGIN)

% Choose default command line output for trackingGUI_small
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes trackingGUI_small wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = trackingGUI_small_OutputFcn(hObject, eventdata, handles) 
